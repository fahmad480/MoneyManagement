...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/categories/import-default', [CategoryController::class, 'getDefaultCategories'])->name('categories.import-default');
    Route::post('/categories/import-default', [CategoryController::class, 'importDefaultCategories'])->name('categories.import-default.store');
