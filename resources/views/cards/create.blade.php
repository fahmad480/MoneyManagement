...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <div class="flex items-center mb-6">
            ...
            <h1 class="text-3xl font-bold text-gray-800">Tambah Kartu</h1>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="card_form" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('card_form') border-red-500 @enderror" required>
                            ...
                            <option value="physical" {{ old('card_form') == 'physical' ? 'selected' : '' }}>Physical</option>
                            <option value="virtual" {{ old('card_form') == 'virtual' ? 'selected' : '' }}>Virtual</option>
                        </select>
                        @error('card_form')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="number" name="transaction_limit" value="{{ old('transaction_limit') }}" 
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description" rows="3" 
                            ...
                            placeholder="Catatan tambahan tentang kartu ini">{{ old('description') }}</textarea>
                        @error('description')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
