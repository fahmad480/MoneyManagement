...
<div class="max-w-3xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-600 mt-1">Perbarui informasi rekening bank</p>
    </div>
        ...
        <form action="{{ route('banks.update', $bank->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="account_nickname" id="account_nickname" 
                           value="{{ old('account_nickname', $bank->account_nickname) }}"
                ...
                <div>
                    ...
                    <select name="bank_type" id="bank_type"
                        ...
                        <option value="digital" {{ old('bank_type', $bank->bank_type) == 'digital' ? 'selected' : '' }}>Digital</option>
                        <option value="conventional" {{ old('bank_type', $bank->bank_type) == 'conventional' ? 'selected' : '' }}>Konvensional</option>
                    </select>
                    @error('bank_type')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" id="description" rows="3"
                              ...
                              placeholder="Catatan tambahan tentang rekening ini...">{{ old('description', $bank->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="flex items-center justify-end gap-3 mt-6 pt-6 border-t border-gray-200">
                ...
                <button type="submit" 
                    ...
                    <i class="fas fa-save mr-2"></i> Update Bank
                </button>
            </div>
        </form>
    </div>
